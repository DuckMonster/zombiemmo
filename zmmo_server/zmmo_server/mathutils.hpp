...
namespace math {
	...
	glm::ivec2 inormalize( glm::ivec2 v );
	int ilength( glm::ivec2 v );

	glm::ivec2 dirToVec( direction::Direction dir );
	direction::Direction vecToDir( glm::ivec2 v );
}
...
namespace random {
    ...
    ///<summary>Random svec2 within a set rectangle</summary>
